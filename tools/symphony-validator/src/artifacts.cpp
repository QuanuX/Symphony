...
bool is_authorized_canonical_json(const std::string& relative_path) {
    ...
    static const std::array<std::string, 255> authorized_paths = {
                    ...
                    if (ext == proj_ext) {
                        ...
                        if (ext == ".json" && is_authorized_canonical_json(rel_path)) {
                            const std::string authority = rel_path.starts_with("knowledge/schemas/v1/validation-")
                                ...
                                : rel_path == "knowledge/scv/schemas/v1/scv-bundle-workflow.schema.json" || rel_path == "knowledge/scv/schemas/v1/scv-bundle-obligation-link.schema.json"
                                ? "knowledge/scv/BUNDLE-WORKFLOWS.md"
                                : rel_path == "knowledge/scv/schemas/v1/bundle.schema.json"
                                ...
                                : rel_path == "knowledge/scv/schemas/v1/administration.schema.json" ||
                                  rel_path == "knowledge/scv/schemas/v1/engine-descriptor-v2.schema.json" ||
                                  rel_path == "knowledge/scv/schemas/v1/profile-preparation.schema.json" ||
                                ...
                                : rel_path == "knowledge/scv/schemas/v1/interpretation-profile.schema.json" ||
