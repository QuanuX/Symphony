  ...
  "records": [
    ...
    },
    {
      ...
      "evidence": [
        ...
        "tools/qxctl/cmd/qxctl/sclv_warning_test.go verifies exact historical-reference selection, acknowledgement and reopen, stale-state refusal, preserved raw evidence, new-record visibility and clean-state delivery isolation."
      ],
      "feature_id": "ssfv:symphony:qxctl.governed-validation",
      "how": "qxctl validates the validator receipt, invokes complete validation or the distinct root-summary projection with an empty environment and deadline, verifies exact identities and nested digests, then applies protected record/review/require policy and a side-by-side subject-aware warning lifecycle after detection. SCLV warning commands select exact historical-reference subjects and reuse the same host-local acceptance and reopening lifecycle.",
      "implementation_languages": [
        {
          "language": "Go",
      ...
      "non_claims": [
        ...
        "Local acknowledgements, workstation logs and build evidence are not canonical or delivered package inputs; delivery verification uses clean build and validation state."
      ],
      "owner_contract": "tools/qxctl/MANIFEST.md",
      "parent_feature_id": "ssfv:symphony:qxctl",
      "record_version": 2,
      ...
      "when": "Runs on explicit validate scan, debug, root-summary, profile, baseline, or warning commands, SCLV historical-warning administration, and reviewed gates that request validator evidence.",
    ...
    },
    {
      ...
      "evidence": [
        ...
        "knowledge/scv/COMPOSITION-WORKFLOWS.md: Owns source/evidence meanings and exact package-to-composition workflow boundaries; qxctl coordinates without acquiring native semantic authority."
      ],
    ...
    },
    {
      ...
      "distinctions": [],
      "evidence": [
        "tools/qxctl/cmd/qxctl/shv_test.go exercises kernel and generic graph routes and exact-version grammar; the corresponding source, partition, PDF, store, publication and profile tests cover their separate commands.",
        ...
        "tools/qxctl/cmd/qxctl/shv_publication.go and shv_publication_evidence.go compose original-owner evidence with protected catalogue selection and recovery.",
        "tools/qxctl/cmd/qxctl/shv_store_transfer.go coordinates explicit graph-store transfers; retained originals and catalogue publication remain separate."
      ],
      ...
      "non_claims": [
        ...
        "Does not own hardware or native storage semantics, grant publication authority, infer authenticated publisher identity from documentary claims, or infer whole-system compatibility from processor fields."
      ],
      "owner_contract": "tools/qxctl/MANIFEST.md",
      "parent_feature_id": "ssfv:symphony:qxctl",
      "record_version": 2,
      "relationships": [
        ...
        {
          "rationale": "Invokes the optional exact native storage writer and reader, including explicit transfer preparation and commit.",
          "target_feature_id": "ssfv:symphony:shv-graph-duckdb-connector",
          "type": "composes_with"
        },
        {
          "rationale": "Invokes exact native partition construction and manifest queries; from-refresh additionally replays original source evidence.",
          "target_feature_id": "ssfv:symphony:shv-partition-engine",
          "type": "composes_with"
        },
        {
          "rationale": "Invokes selected documentary extraction and graph projection while preserving decoder and original-PDF evidence.",
          "target_feature_id": "ssfv:symphony:shv-pdf-adapter",
          "type": "composes_with"
        },
        {
          "rationale": "Invokes caller-defined profile, diagnostic and portable universe operations through the selected native owner.",
          "target_feature_id": "ssfv:symphony:shv-profile-engine",
          "type": "composes_with"
        },
        {
          "rationale": "Invokes native catalogue manifest and head-selection reducers; qxctl separately enforces permission-backed persistence and recovery.",
          "target_feature_id": "ssfv:symphony:shv-publication-engine",
          "type": "composes_with"
        },
        {
      ...
      "what": "Administers exact SHV kernel, source, partition, PDF, profile, generic graph, durable graph storage and catalogue publication owners through the existing qxctl shv commands. Source activation and catalogue publication consume separate explicit authority and support recovery. Caller-selected profiles, diagnostics, inventory, dossiers and portable universes preserve their original evidence and owner identities.",
      "when": "Runs on explicit cold/freezing administrative invocation, including caller-requested retention, transfer, separately authorized source or catalogue selection, and exact-operation recovery.",
