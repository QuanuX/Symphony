...
Implements `symphony.maestro.knowledge-engine-docking.v1` using the common bounded local process envelope. One exact receptor owns a protected digest-linked presence registry per TOPS.
