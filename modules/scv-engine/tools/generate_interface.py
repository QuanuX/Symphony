...
def validate(manifest):
    ...
    for release in releases:
        ...
        if any(surface not in ("corpus", "workflow", "artifact", "schema", "interface", "composition_workflow", "composition_bundle_workflow", "composition_bundle_obligation_link") for surface in release["surfaces"]):
