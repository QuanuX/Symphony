  ...
  "records": [
    {
      ...
      "status": "experimental",
      "title": "Symphony Cloud Vector source-knowledge engine",
      "what": "Provider and family composition, source knowledge and explicit evidence-based comparisons. Provides independently installable source planning, validation, capture import, interpretation, graph, query, difference and explanation operations.",
