...
class InterfaceGeneration(unittest.TestCase):
    ...
    def test_historical_projection_is_frozen(self):
        ...
        self.assertEqual([len(gen.projection(self.manifest, f"0.{n}.0-dev")["operations"]) for n in range(1, 10)], [13, 17, 20, 21, 22, 26, 26, 28, 30])
    ...
    def test_future_domain_does_not_change_old_admission_or_definition(self):
        ...
        next_release["version"] = "0.10.0-dev"
        self.manifest["releases"].append(next_release)
        self.manifest["current_release"] = "0.10.0-dev"
        self.manifest["domains"].append({"name": "scev-new-provider", "introduced_in": "0.10.0-dev"})
        ...
        self.assertIn("scev-new-provider", gen.projection(self.manifest, "0.10.0-dev")["domains"])
    ...
    def test_malformed_manifest_rejected(self):
        mutations = [
            ...
            lambda m: m.update(current_release="0.10.0-dev"),
