...
- For Named Versions, require exact SAV receipt/executable validation evidence at prepare, a fresh SSIAG decision on every call, exact registry compare-and-swap for mutation, and SAV revalidation after reads. Never treat an alias as identity, infer newest, rewrite an object, or claim STAV closure while append integration is disabled.
