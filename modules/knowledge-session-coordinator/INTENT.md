...
qxctl also binds the exact SAV and coordinator installations for the implemented Named Version persistence circuit. Safe STAV event vocabulary and append closure for that circuit remain separately gated and unimplemented.
