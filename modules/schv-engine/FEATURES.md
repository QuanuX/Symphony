  ...
  "records": [
    {
      ...
      "implementation_languages": [
        {
          "language": "C++26",
          "role": "Owns pure domain validation, source transitions and bounded knowledge interpretation/projection."
        },
        {
          "language": "CMake",
          "role": "Independently builds, installs and receipts the exact domain package."
        }
      ],
      ...
      "kind": "feature",
      "non_claims": [
        "Does not grant authority, durably persist the computed transition, select a graph head, execute a provider action or mutate canonical knowledge.",
        "Does not claim complete vendor coverage, automatic interpretation of unknown formats, a general Composer, operational credentials or a published release."
      ],
      "owner_contract": "modules/schv-engine/SPEC.md",
      ...
      "status": "experimental",
      "title": "Symphony Cloud Hyperscalers Vector source-knowledge engine",
      "what": "Hyperscaler and cloud-hosting family knowledge, preserving each provider vocabulary. Provides independently installable source planning, validation, capture import, interpretation, graph, query, difference and explanation operations.",
