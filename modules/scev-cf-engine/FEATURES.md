  ...
  "records": [
    {
      ...
      "status": "experimental",
      "title": "Symphony Cloud Edge Vector \u2014 Cloudflare source-knowledge engine",
      "what": "Cloudflare-native source, service, platform version and constraint knowledge. Provides independently installable source planning, validation, capture import, interpretation, graph, query, difference and explanation operations.",
