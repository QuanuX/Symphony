# SHV partition engine — INSTALL.md

Canonical semantics: `knowledge/shv/PARTITIONS.md`, installed alongside this document as PARTITIONS.md. Independent C++26 package shv-partition-engine0.1.0-dev, receipt-v2 entry point symphony-shv-partition. Four pure bounded operations; qxctl administers every operation and receipt-owned discovery. Direct inputs are caller-declared dependency references, not authenticated hardware evidence.
