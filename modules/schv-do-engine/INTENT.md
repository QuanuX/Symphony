...
Provide independently installable C++26 source-knowledge computation for `schv-do` in the freezing path. DigitalOcean-native source, offering, service, version and constraint knowledge. The shared implementation preserves native source meaning, durable provenance supplied by its storage adapter and reproducible graph projections. It is useful without a parent engine, provider credentials, an AI service, a database server or a network listener.
