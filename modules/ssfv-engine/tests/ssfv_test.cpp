...
void test_descriptor_and_actual_repository(const fs::path& repository_root) {
    ...
    require(check.at("feature_count") == 76U && check.at("feature_file_count") == 15U,
    ...
    require(graph.at("node_count") == 76U && graph.at("edge_count") == 309U,
    ...
    require(full_administration.at("summary").at("features_checked") == 76U &&
                full_administration.at("summary").at("surfaces_checked") == 147U &&
                full_administration.at("summary").at("satisfied") == 124U &&
