...
void test_descriptor_and_actual_repository(const fs::path& repository_root) {
    ...
    require(check.at("feature_count") == 78U && check.at("feature_file_count") == 17U,
    ...
    require(graph.at("node_count") == 78U && graph.at("edge_count") == 319U,
    ...
    require(full_administration.at("summary").at("features_checked") == 78U &&
                full_administration.at("summary").at("surfaces_checked") == 156U &&
                full_administration.at("summary").at("satisfied") == 133U &&
