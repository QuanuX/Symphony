...
if(NOT TARGET scv-domain-core)
    add_library(scv-domain-core STATIC "${SCV_SOURCE_DIR}/src/source.cpp" "${SCV_SOURCE_DIR}/src/knowledge.cpp" "${SCV_SOURCE_DIR}/src/dispatch.cpp")
...
if(BUILD_TESTING)
    ...
    add_test(NAME scv-installed-process-integration COMMAND ${Python3_EXECUTABLE}
        "${SCV_SOURCE_DIR}/tests/installed_integration.py" --build "${CMAKE_CURRENT_BINARY_DIR}" --domain "${SYMPHONY_SCV_DOMAIN}")
endif()
...
if(SYMPHONY_SCV_DOMAIN STREQUAL "scv" AND SYMPHONY_SCV_BUILD_ALL_DOMAINS)
    foreach(domain schv scev schv-aws schv-azure schv-do schv-gcp scev-cf)
