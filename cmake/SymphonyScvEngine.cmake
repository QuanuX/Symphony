...
if(NOT TARGET scv-domain-core)
    add_library(scv-domain-core STATIC "${SCV_SOURCE_DIR}/src/source.cpp" "${SCV_SOURCE_DIR}/src/knowledge.cpp" "${SCV_SOURCE_DIR}/src/corpus.cpp" "${SCV_SOURCE_DIR}/src/interpretation.cpp" "${SCV_SOURCE_DIR}/src/coverage.cpp" "${SCV_SOURCE_DIR}/src/pack.cpp" "${SCV_SOURCE_DIR}/src/composition.cpp" "${SCV_SOURCE_DIR}/src/bundle.cpp" "${SCV_SOURCE_DIR}/src/dispatch.cpp")
...
if(BUILD_TESTING)
    ...
    if(SYMPHONY_SCV_DOMAIN STREQUAL "scv")
        ...
        foreach(area pack composition obligation bundle)
