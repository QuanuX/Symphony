...
- SHV graph ontology and engine; full SCV provider ontologies, dedicated graph database traversal beyond the optional DuckDB relational index, broader acquisition adapters or a network query API beyond the admitted bounded source-knowledge process profile;
