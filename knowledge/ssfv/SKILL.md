...
This skill is procedural contract guidance for the implemented engine, qxctl client, reviewed sparse-record workflow, explicit owner-scope coverage inventory, and protected noncanonical session-maintenance circuit. The existing sixty-seven-record partial catalog authorizes no unreviewed feature record, unregistered application `FEATURES.md`, complete-catalog claim, canonical mutation, graph database, Maestro state mutation through SSFV, public documentation, or marketing output.
