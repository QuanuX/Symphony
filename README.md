...
- [STAV Protocol for Go](libraries/stav-protocol-go/) is an authority-free Go library implementing the canonical STAV v1 codec, validation, digest, framing, conformance rules, and closed producer-vocabulary validation. The first Accordare vocabulary reserves four SAV Named Version lifecycle tuples while keeping both runtime production and its producer grant explicitly disabled.
...
- The SAV Named Version circuit has an installed-host acceptance harness that builds and installs exact receipt-v2 SAV and coordinator packages, binds them through qxctl state, obtains caller-neutral SSIAG decisions, and proves prepare, seal, replay, alias, lookup, and status against the real C++ processes. This is acceptance evidence for the existing circuit, not a claim that Accordare STAV production is enabled.
...
- SSFV catalog state: `partial`; registered features: **89**; registered owner scopes: **17**; ratified nested features: **69**.
- Feature-administration expectations: **175** reviewed surfaces; **165** required, **13** evidence-backed exemptions, **9** prohibitions, **0** unreviewed.
- qxctl stable command identities: **195**.
...
- Snapshot digest: `sha256:dcab98c7d65c21df8935dcf768b24c1c779c376c93c275b893d538fbe55977aa`
