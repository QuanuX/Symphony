...
- SSFV catalog state: `partial`; registered features: **76**; registered owner scopes: **14**; ratified nested features: **59**.
- Feature-administration expectations: **147** reviewed surfaces; **136** required, **13** evidence-backed exemptions, **10** prohibitions, **0** unreviewed.
- qxctl stable command identities: **157**.
...
- Snapshot digest: `sha256:6ffd87ee6341e646b1e6e65f5412de1acd188c3243d058d07ece4b213b1afe01`
