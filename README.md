...
- SSFV catalog state: `partial`; registered features: **106**; registered owner scopes: **28**; ratified nested features: **73**.
- Feature-administration expectations: **278** reviewed surfaces; **268** required, **13** evidence-backed exemptions, **9** prohibitions, **0** unreviewed.
- qxctl stable command identities: **323**.
...
- Snapshot digest: `sha256:b788972ebcdb1fa6aeb365b058487bd261e546141e6a5e878eb6802416a70dd7`
