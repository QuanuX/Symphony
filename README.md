...
- SSFV catalog state: `partial`; registered features: **108**; registered owner scopes: **28**; ratified nested features: **73**.
- Feature-administration expectations: **286** reviewed surfaces; **276** required, **13** evidence-backed exemptions, **9** prohibitions, **0** unreviewed.
- qxctl stable command identities: **350**.
...
- Snapshot digest: `sha256:101ee93835c29d7d805c100561b3467b018d480a9ebfcf8737aa1e11ef8b2b67`
