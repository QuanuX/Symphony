...
- SSFV catalog state: `partial`; registered features: **107**; registered owner scopes: **28**; ratified nested features: **73**.
- Feature-administration expectations: **281** reviewed surfaces; **271** required, **13** evidence-backed exemptions, **9** prohibitions, **0** unreviewed.
- qxctl stable command identities: **339**.
...
- Snapshot digest: `sha256:9d6ad8d4907c447379209c1ab091c0e3cc3d4ef3ecaa0ae723efb55d59008e6a`
