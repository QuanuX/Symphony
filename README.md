...
- SSFV catalog state: `partial`; registered features: **72**; registered owner scopes: **14**; ratified nested features: **57**.
- Feature-administration expectations: **137** reviewed surfaces; **126** required, **13** evidence-backed exemptions, **10** prohibitions, **0** unreviewed.
- qxctl stable command identities: **148**.
...
- Snapshot digest: `sha256:01bf382760a252fa1a5850a0aeb7df2cb2bcd06f085701376c51c697f1b5c5bd`
