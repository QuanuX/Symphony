...
- [Symphony Validator](tools/symphony-validator/) is a deterministic, read-only C++26 repository checker with line and structured JSON evidence, stable exit behavior, exact versioned installation/uninstallation, qxctl mediation, and extensive smoke fixtures. CI wiring and a Markdown projection remain deferred.
