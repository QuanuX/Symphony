...
- SSFV catalog state: `partial`; registered features: **74**; registered owner scopes: **14**; ratified nested features: **59**.
- Feature-administration expectations: **145** reviewed surfaces; **134** required, **13** evidence-backed exemptions, **10** prohibitions, **0** unreviewed.
- qxctl stable command identities: **156**.
...
- Snapshot digest: `sha256:9dd814fdfd1feb376da5d97128db13480e48d1db7473387ed43ddd2211b76de3`
