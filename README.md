...
- SSFV catalog state: `partial`; registered features: **87**; registered owner scopes: **16**; ratified nested features: **68**.
- Feature-administration expectations: **170** reviewed surfaces; **159** required, **13** evidence-backed exemptions, **10** prohibitions, **0** unreviewed.
- qxctl stable command identities: **191**.
...
- Snapshot digest: `sha256:97eb486e4ba5bfe74b85ea2577721687a3d13af29b23f7526b16cb825bde2a1d`
